  ...
  return (
    <div>
      ...
      <main className="max-w-4xl mx-auto p-6 space-y-10">
        ...
        <section className="bg-white rounded-2xl shadow-md p-6">
          <h2 className="text-xl font-semibold text-blue-900 mb-4">Register</h2>
          <form className="space-y-4">
            <input type="text" placeholder="Full Name" className="w-full border p-2 rounded-lg" required />
            <input type="email" placeholder="Email address" className="w-full border p-2 rounded-lg" required />
            <input type="password" placeholder="Create a password" className="w-full border p-2 rounded-lg" required />
            <button type="submit" className="w-full bg-blue-900 text-white py-2 rounded-lg hover:bg-blue-800">Register</button>
          </form>
        </section>

        <section className="bg-white rounded-2xl shadow-md p-6">
          <h2 className="text-xl font-semibold text-blue-900 mb-4">Your Cart</h2>
          <div className="text-gray-600">No items in cart.</div>
        </section>

        <section className="bg-white rounded-2xl shadow-md p-6">
          <h2 className="text-xl font-semibold text-blue-900 mb-4">About Us</h2>
          <p className="text-gray-700">MDM Sport Store offers top-quality sports equipment for athletes of all levels. We value performance and style.</p>
        </section>
      </main>
